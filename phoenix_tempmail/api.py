...
app = FastAPI()
app.mount("/home", StaticFiles(directory="phoenix-webmail",
          html=True), name="phoenix-webmail")
database = database.db()
manager = ConnectionManager()

config = {}
try:
    with open("/opt/phoenix_tempmail/phoenix_tempmail/config.json", "r") as config:
